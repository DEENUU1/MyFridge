...
urlpatterns = [
    ...
    path(
        "meal-plan/create",
        views.MealDailyPlanCreateView.as_view(),
        name="meal_plan_create",
    ),
    path(
        "meal-plan/update/<int:pk>",
        views.MealDailyPlanUpdateView.as_view(),
        name="meal_plan_update",
    ),
    path(
        "meal-plan/delete/<int:pk>",
        views.MealDailyPlanDeleteView.as_view(),
        name="meal_plan_delete",
    ),
    path(
        "meal-plan/details/<int:pk>",
        views.MealDailyPlanDetailView.as_view(),
